...
//        return userMapper.selectById(id);
    ...
    public Map<String, Object> register(User user){
        ...
        //url: http://localhost:8888/community/activatin/101/code
    ...
    public Map<String, Object> login(String username, String password, long experiedSeconds){
        Map<String, Object> map = new HashMap<>();
        ...
        // 验证密码
        String p1 = CommunityUtil.md5(password+user.getSalt());
...
//        return userMapper.updateHeaderUrl(userId, headerUrl);
    ...
    // 3.数据变更时清除缓存数据（比改要好，因为改的话可能涉及并发问题）
